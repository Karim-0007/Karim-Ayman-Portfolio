...
// Isolated animated SVG icons to prevent parent re-renders
const AnimatedArrowIcon = memo(() => (
  <motion.svg
...
const AnimatedDownloadIcon = memo(() => (
  <motion.svg
    xmlns="http://www.w3.org/2000/svg"
    className="w-4 h-4"
    fill="none"
    ...
    >
      ...
      <div className="h-auto w-full lg:w-[60%] flex flex-col gap-5 justify-center text-start rounded-[32px] border border-[#7042f833] bg-[rgba(3,0,20,0.92)] px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-10">
        <motion.div
          ...
          style={{ width: "max-content", willChange: "transform, opacity" }}
        >
