    ...
    >
      ...
      <div className="h-full w-full lg:w-[60%] flex flex-col gap-5 justify-center text-start rounded-[32px] border border-[#7042f833] bg-[rgba(3,0,20,0.62)] px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-10 backdrop-blur-sm">
        ...
        >
          <div className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b]">
            ...
            <h1 className="Welcome-text text-[11px] sm:text-[13px] font-semibold">
              Ready for a new chapter in my professional career
            </h1>
          </div>
        </motion.div>
      ...
      >
        <Image
          ...
          draggable={false}
          loading="eager"
          className="box select-none w-[200px] sm:w-[250px] md:w-[300px] lg:w-[350px] h-auto cursor-pointer object-top border-4 border-[#7042f88b] rounded-full opacity-[0.7] transition-all duration-300 ease-in-out hover:scale-105 hover:opacity-90 hover:border-purple-500/50 mb-8 lg:mb-100"
        />
      </motion.div>
    </motion.div>
  );
